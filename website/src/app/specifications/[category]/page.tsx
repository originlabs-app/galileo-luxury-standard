...
function SpecCard({ spec, category }: SpecCardProps) {
  ...
  return (
    <Link
      ...
      className="group block p-5 rounded-lg border border-[var(--platinum)]/10 bg-[var(--obsidian)]/50 hover:border-[var(--antique-gold)]/50 transition-all duration-300 angle-glow"
    >
      <div className="flex items-start justify-between gap-4 mb-3">
        <div className="flex items-center gap-3">
          ...
          />
          <h3 className="font-semibold text-[var(--platinum)] group-hover:text-[var(--antique-gold)] transition-colors line-clamp-1">
            {spec.title}
          </h3>
        </div>
...
export default async function CategoryPage({
  ...
  return (
    <div className="max-w-4xl">
      ...
      <Link
        href="/specifications"
        className="inline-flex items-center gap-2 text-sm text-[var(--platinum-dim)] hover:text-[var(--antique-gold)] transition-colors mb-6"
      >

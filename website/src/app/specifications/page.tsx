...
function CategoryCard({ name, count, previewSpecs }: CategoryCardProps) {
  ...
  return (
    <Link
      ...
      className="group block p-6 rounded-lg border border-[var(--platinum)]/10 bg-[var(--obsidian)]/50 hover:border-[var(--antique-gold)]/50 transition-all duration-300 angle-glow"
    >
      {/* Header */}
      <div className="flex items-start justify-between mb-4">
        <div className="p-2 rounded-lg bg-[var(--antique-gold)]/10 text-[var(--antique-gold)]">
      ...
      {/* Title */}
      <h2 className="text-lg font-semibold text-[var(--platinum)] mb-2 group-hover:text-[var(--antique-gold)] transition-colors">
...
export default async function SpecificationsPage() {
  ...
  return (
    <div className="max-w-4xl">
      {/* Page header */}
      <div className="mb-12">
        <h1 className="text-4xl font-bold text-[var(--platinum)] mb-4">
      ...
      {/* Status legend */}
      <div className="flex items-center gap-6 mb-8 p-4 rounded-lg bg-[var(--obsidian)]/50 border border-[var(--platinum)]/10">

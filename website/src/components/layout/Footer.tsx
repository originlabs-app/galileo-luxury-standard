        ...
        <div className="container mx-auto px-6 md:px-8 relative z-10">
          ...
          >
            ...
            <p className="text-base md:text-lg text-white/40 font-light mb-12 max-w-xl mx-auto">
              You&apos;ve witnessed the depths. You understand the truth. Now
              bring that clarity to your products.
            </p>
          ...
          <div className="grid md:grid-cols-4 gap-12">
            ...
            <div className="md:col-span-1">
              ...
              <p className="text-sm text-white/60 leading-relaxed max-w-xs text-left">
                The open standard for luxury product authentication. Dive into
                truth.
              </p>

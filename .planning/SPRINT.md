...
| 3 | Dashboard product list: filter UI (status + category dropdowns) | EPIC-002 | in_progress | Selecting a filter updates the product list. Clearing filter shows all products. | |
